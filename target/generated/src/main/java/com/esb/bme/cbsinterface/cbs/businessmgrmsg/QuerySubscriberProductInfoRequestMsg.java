...
import com.esb.bme.cbsinterface.cbs.businessmgr.QuerySubscriberProductInfoRequest;
 ...
 *         &lt;element name="QuerySubscriberProductInfoRequest" type="{http://www.esb.com/bme/cbsinterface/cbs/businessmgr}QuerySubscriberProductInfoRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "QuerySubscriberProductInfoRequestMsg")
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "QuerySubscriberProductInfoRequest", required = true)
