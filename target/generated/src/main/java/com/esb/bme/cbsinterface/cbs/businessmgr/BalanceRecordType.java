    ...
    implements Serializable
{
    ...
    @XmlElementRef(name = "MinMeasureId", namespace = "http://www.esb.com/bme/cbsinterface/cbs/businessmgr", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> minMeasureId;
    @XmlElementRef(name = "UnitType", namespace = "http://www.esb.com/bme/cbsinterface/cbs/businessmgr", type = JAXBElement.class, required = false)
    protected JAXBElement<Integer> unitType;
    @XmlElement(name = "AccountType", required = true)
    protected String accountType;
    @XmlElement(name = "ExpireTime", required = true)
    protected String expireTime;
    @XmlElementRef(name = "AccountCredit", namespace = "http://www.esb.com/bme/cbsinterface/cbs/businessmgr", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> accountCredit;
    @XmlElementRef(name = "AccountKey", namespace = "http://www.esb.com/bme/cbsinterface/cbs/businessmgr", type = JAXBElement.class, required = false)
    protected JAXBElement<String> accountKey;
    @XmlElementRef(name = "ProductID", namespace = "http://www.esb.com/bme/cbsinterface/cbs/businessmgr", type = JAXBElement.class, required = false)
