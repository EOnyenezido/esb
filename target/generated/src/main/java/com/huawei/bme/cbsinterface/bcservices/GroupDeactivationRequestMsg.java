 ...
 *         &lt;element name="GroupDeactivationRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}GroupDeactivationRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GroupDeactivationRequestMsg")
