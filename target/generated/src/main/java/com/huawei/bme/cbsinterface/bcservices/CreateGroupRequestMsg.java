 ...
 *         &lt;element name="CreateGroupRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}CreateGroupRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CreateGroupRequestMsg")
