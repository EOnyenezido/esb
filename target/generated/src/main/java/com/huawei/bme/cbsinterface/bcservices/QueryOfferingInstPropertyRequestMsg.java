 ...
 *         &lt;element name="QueryOfferingInstPropertyRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}QueryOfferingInstPropertyRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "QueryOfferingInstPropertyRequestMsg")
public class QueryOfferingInstPropertyRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "QueryOfferingInstPropertyRequest", namespace = "", required = true)
    ...
    /**
     * Gets the value of the queryOfferingInstPropertyRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the queryOfferingInstPropertyRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link QueryOfferingInstPropertyRequest }
