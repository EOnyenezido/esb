 ...
 *         &lt;element name="ChangeAcctInfoRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}ChangeAcctInfoRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeAcctInfoRequestMsg")
public class ChangeAcctInfoRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "ChangeAcctInfoRequest", namespace = "", required = true)
    ...
    /**
     * Gets the value of the changeAcctInfoRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the changeAcctInfoRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link ChangeAcctInfoRequest }
