...
/**
 * <p>Java class for ChangeGroupMemberOfferingResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ChangeGroupMemberOfferingResult"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ChangeGroupMemberOfferingResult", propOrder = {
    "modifyOffering"
})
public class ChangeGroupMemberOfferingResult
    implements Serializable
{

    private final static long serialVersionUID = 11082012L;
    @XmlElement(name = "ModifyOffering")
    protected List<ChangeGroupMemberOfferingResult.ModifyOffering> modifyOffering;
     ...
     * {@link ChangeGroupMemberOfferingResult.ModifyOffering }
     * 
     * 
     */
    public List<ChangeGroupMemberOfferingResult.ModifyOffering> getModifyOffering() {
        if (modifyOffering == null) {
            modifyOffering = new ArrayList<ChangeGroupMemberOfferingResult.ModifyOffering>();
        }
