 ...
 *         &lt;element name="ChangePayRelationRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}ChangePayRelationRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangePayRelationRequestMsg")
public class ChangePayRelationRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "ChangePayRelationRequest", namespace = "", required = true)
    ...
    /**
     * Gets the value of the changePayRelationRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the changePayRelationRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link ChangePayRelationRequest }
