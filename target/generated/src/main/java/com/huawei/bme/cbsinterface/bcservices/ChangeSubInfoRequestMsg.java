 ...
 *         &lt;element name="ChangeSubInfoRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}ChangeSubInfoRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeSubInfoRequestMsg")
public class ChangeSubInfoRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "ChangeSubInfoRequest", namespace = "", required = true)
    ...
    /**
     * Gets the value of the changeSubInfoRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the changeSubInfoRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link ChangeSubInfoRequest }
