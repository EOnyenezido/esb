...
import com.huawei.bme.cbsinterface.cbs.accountmgr.QueryTransferLogRequest;
 ...
 *         &lt;element name="QueryTransferLogRequest" type="{http://www.huawei.com/bme/cbsinterface/cbs/accountmgr}QueryTransferLogRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "QueryTransferLogRequestMsg")
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "QueryTransferLogRequest", required = true)
