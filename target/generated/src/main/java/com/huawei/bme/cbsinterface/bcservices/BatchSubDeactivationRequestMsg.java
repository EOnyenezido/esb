 ...
 *         &lt;element name="BatchSubDeactivationRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}BatchSubDeactivationRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "BatchSubDeactivationRequestMsg")
public class BatchSubDeactivationRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "BatchSubDeactivationRequest", namespace = "", required = true)
    ...
    /**
     * Gets the value of the batchSubDeactivationRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the batchSubDeactivationRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link BatchSubDeactivationRequest }
