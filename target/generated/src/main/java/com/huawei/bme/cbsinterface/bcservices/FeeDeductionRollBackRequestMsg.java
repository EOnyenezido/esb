 ...
 *         &lt;element name="FeeDeductionRollBackRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}FeeDeductionRollBackRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "FeeDeductionRollBackRequestMsg")
public class FeeDeductionRollBackRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "FeeDeductionRollBackRequest", namespace = "", required = true)
