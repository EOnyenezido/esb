 ...
 *         &lt;element name="ChangeCustInfoRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}ChangeCustInfoRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeCustInfoRequestMsg")
public class ChangeCustInfoRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "ChangeCustInfoRequest", namespace = "", required = true)
    ...
    /**
     * Gets the value of the changeCustInfoRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the changeCustInfoRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link ChangeCustInfoRequest }
