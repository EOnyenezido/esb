 ...
 *         &lt;element name="ChangeGroupOfferingRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}ChangeGroupOfferingRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeGroupOfferingRequestMsg")
