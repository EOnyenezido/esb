 ...
 *         &lt;element name="ChangeOfferingPropertyRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}ChangeOfferingPropertyRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ChangeOfferingPropertyRequestMsg")
