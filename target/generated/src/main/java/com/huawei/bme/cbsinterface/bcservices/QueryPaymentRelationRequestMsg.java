 ...
 *         &lt;element name="QueryPaymentRelationRequest" type="{http://www.huawei.com/bme/cbsinterface/bcservices}QueryPaymentRelationRequest" form="unqualified"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "QueryPaymentRelationRequestMsg")
public class QueryPaymentRelationRequestMsg
    implements Serializable
{
    ...
    @XmlElement(name = "QueryPaymentRelationRequest", namespace = "", required = true)
    ...
    /**
     * Gets the value of the queryPaymentRelationRequest property.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Sets the value of the queryPaymentRelationRequest property.
     * 
     * @param value
     *     allowed object is
     *     {@link QueryPaymentRelationRequest }
